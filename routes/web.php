...
Route::group([
    ...
    Route::group(['middleware' => 'check.admin'], function () {
        ...
        Route::group(['prefix' => 'book'], function () {
            Route::get('/', 'BookController@list')->name('admin.book.list');
            Route::get('/get-data', 'BookController@get_data')->name('admin.book.get_data');
            Route::get('/create', 'BookController@create')->name('admin.book.create');
            Route::post('/do-create', 'BookController@do_create')->name('admin.book.do_create');
            Route::get('/edit/{id}', 'BookController@edit')->name('admin.book.edit');
            Route::post('/do-edit/{id}', 'BookController@do_edit')->name('admin.book.do_edit');
            Route::post('/sorting', 'BookController@sorting')->name('admin.book.sorting');
            Route::post('/delete', 'BookController@delete')->name('admin.book.delete');
            Route::get('/deleted', 'BookController@list_deleted')->name('admin.book.deleted');
            Route::get('/get-data-deleted', 'BookController@get_data_deleted')->name('admin.book.get_data_deleted');
            Route::post('/restore', 'BookController@restore')->name('admin.book.restore');
        });
